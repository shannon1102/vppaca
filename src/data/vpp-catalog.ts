...
export const seedBanners: Banner[] = [
  {
    id: "ban-1",
    title: "Back to Office — Giảm đến 30%",
    image_url: "/brand/aca-logo-hero.png",
  ...
  {
    id: "ban-2",
    title: "Giấy A4 — Giá sỉ cho doanh nghiệp",
    image_url: "/products/giay-a4-ream-02.jpg",
    link_url: "/danh-muc/giay-in-so-vo",
    sort: 2,
    starts_at: null,
    ends_at: null,
    is_active: true,
  ...
  {
    id: "ban-3",
    title: "Báo giá B2B — Upload Excel",
    image_url: "/seed/product-07.svg",
